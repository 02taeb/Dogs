...
public class AssignmentSevenPointSixPointFourTest extends AssignmentSevenPointSixTest {
	...
	// 	assertDogsAre("Den sorterade listan av hundar är inte korrekt", SORTED_ORDER_OF_PREPARED_DOGS);
	// 	assertEquals(8, swaps, "Fel antal byten");
	// }

	// @Test
	// public void sortEmptyList() {
	// 	var swaps = callMethodUnderTest(sut);
	// 	assertDogsAre("Listan av hundar borde vara tom");
	// 	assertEquals(0, swaps, "Fel antal byten");
	// }
